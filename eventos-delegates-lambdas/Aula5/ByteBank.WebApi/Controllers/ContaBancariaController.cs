...
namespace ByteBank.WebApi.Controllers
{
    ...
    public class ContaBancariaController : ControllerBase
    {
        ...
        public ActionResult<ExtratoBancario> Extrato(string agencia, string conta)
        {
            ...
            //var items = ItemsExtrato.Where(ie => ie.Agencia.Equals(agencia) && ie.Conta.Equals(conta))
            //    .OrderBy(ie => ie.Data)
            //    .ToList();
        ...
        private static ContaCorrente? GetContaCorrente(string agencia, string conta)
        {
            ...
            //return ContasCorrentes.Where(cc => cc.Agencia.Equals(agencia) && cc.Conta.Equals(conta)).SingleOrDefault();
